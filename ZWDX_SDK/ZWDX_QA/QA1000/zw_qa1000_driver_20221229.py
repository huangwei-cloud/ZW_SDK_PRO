...
path_new =  '.\\ZW_XDMA_PLL_20221230.dll'
...
#                        self.ad_ch.append(['slot'+str(BoardSlot[i]),ch_i,'8ad8da'])
                    if BoardSlot[i] == 1:
                        for ch_i in range(6):
                            self.da_ch[ch_i+6] = ['slot'+str(BoardSlot[i]),7-ch_i,'8ad8da']
                            self.ad_ch[ch_i+6] = ['slot'+str(BoardSlot[i]),5-ch_i,'8ad8da']
                    else:
                        for ch_i in range(6):
                            self.da_ch[ch_i] = ['slot'+str(BoardSlot[i]),7-ch_i,'8ad8da']
                            self.ad_ch[ch_i] = ['slot'+str(BoardSlot[i]),5-ch_i,'8ad8da']
